...
public class AliCloudCommand extends AbstractNamedProviderCommand {
  ...
  public AliCloudCommand() {
    registerSubcommand(new AliCloudAccountCommand());
    registerSubcommand(new AliCloudEditProviderCommand());
    registerSubcommand(new AliCloudBakeryCommand());
    registerSubcommand(new AliCloudBaseImageCommand());
  }
}
